...
class Chatbox(ctk.CTkFrame):
    def __init__(self,parent,controller):
        ...
        self.settings_button2 = ctk.CTkButton(
            self.sidebar_frame, text="Settings", corner_radius=0, fg_color="gray10",hover_color="gray20",command=lambda: controller.show_frame("setting")
        )
    ...
    def apply_chatbox_theme(self, mode):
        if mode == "Dark Mode":
            self.chatFrame.configure(fg_color="gray20")
            self.sidebar_frame.configure(fg_color="gray10")
            self.settings_button1.configure(fg_color="gray10", text_color="white", hover_color="gray20")
            self.settings_button2.configure(fg_color="gray10", text_color="white", hover_color="gray20")
            self.back_button.configure(fg_color="gray20", hover_color="gray30")
            self.sidebar_button.configure(fg_color="gray20", hover_color="gray30")
            self.add_button.configure(fg_color="gray20", hover_color="gray30")

            self.text_box1.configure(
                fg_color="gray20",
                text_color="white"
            )
            self.text_box2.configure(
                fg_color="gray50",
                text_color="black"
            )

        else:  # Default mode
            self.chatFrame.configure(fg_color="white")
            self.sidebar_frame.configure(fg_color="#f0f0f0")
            self.settings_button1.configure(fg_color="#f0f0f0",text_color="black",hover_color="white")
            self.settings_button2.configure(fg_color="#f0f0f0", text_color="black",hover_color="white")
            self.back_button.configure(fg_color="white",hover_color="#f0f0f0")
            self.sidebar_button.configure(fg_color="white",hover_color="#f0f0f0")
            self.add_button.configure(fg_color="white",hover_color="#f0f0f0")
